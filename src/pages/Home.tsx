        ...
        <div className="container mx-auto px-4 relative z-10 pt-20 pb-24">
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
            <h1 className="space-y-3">
              <span className="block text-6xl md:text-8xl font-black tracking-tight bg-gradient-to-r from-blue-700 via-blue-600 to-purple-600 dark:from-blue-400 dark:via-blue-300 dark:to-purple-400 bg-clip-text text-transparent">
                Big Good
              </span>
              <span className="block text-2xl md:text-4xl font-bold text-gray-900 dark:text-white tracking-tight max-w-3xl mx-auto leading-snug">
